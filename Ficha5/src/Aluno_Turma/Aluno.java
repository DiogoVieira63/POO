...
public class Aluno implements Comparable<Aluno>{
    ...
    /**
     * Constructores para a classe Aluno_Turma.Aluno
     */
    public Aluno() {
      this.numero = "";
      this.nota = 0;
   ...
   public void setCurso(String curso) {
    ...
    /**
    * Implementação do método de igualdade entre dois Aluno_Turma.Aluno
    ...
    */
    ...
    /**
    * Implementação do método de clonagem de um Aluno_Turma.Aluno
    * 
    * @return  objecto do tipo Aluno_Turma.Aluno
    */
