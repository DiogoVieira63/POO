...
public class EncEficiente {
    ...
    private String encomendaNumber;
    ...
    EncEficiente(){
        ...
        this.encomendaNumber = "n/a";
        this.date = LocalDate.now();
        this.array = new ArrayList<LinhaEncomenda>();
    }


    public EncEficiente(String clientName, int fiscalNumber, String clientAdress, String encomendaNumber, LocalDate date, ArrayList<LinhaEncomenda> array) {
    ...
    public String getEncomendaNumber() {
        return encomendaNumber;
    }

    public void setEncomendaNumber(String encomendaNumber) {
        this.encomendaNumber = encomendaNumber;
    }
